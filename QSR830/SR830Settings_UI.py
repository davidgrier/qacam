...
class Ui_SR830Settings(object):
    def setupUi(self, SR830Settings):
        ...
        self.frequency = QtGui.QDoubleSpinBox(self.frameReference)
        ...
        self.amplitude = QtGui.QDoubleSpinBox(self.frameReference)
        ...
        self.phase = QtGui.QDoubleSpinBox(self.frameReference)
    ...
    def retranslateUi(self, SR830Settings):
        ...
        self.frequency.setSuffix(_translate("SR830Settings", " Hz", None))
        self.amplitude.setSuffix(_translate("SR830Settings", " Vrms", None))
        self.phase.setSuffix(_translate("SR830Settings", "°", None))
