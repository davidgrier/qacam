...
class Ui_Qacam(object):
    def setupUi(self, Qacam):
        ...
        self.controlWidget.setMinimumSize(QtCore.QSize(340, 0))
        self.controlWidget.setMaximumSize(QtCore.QSize(350, 16777215))
        self.controlWidget.setObjectName("controlWidget")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.controlWidget)
        ...
        self.verticalLayout_7.addWidget(self.labelPolargraph)
        self.framePolargraph = QtWidgets.QFrame(self.controlWidget)
        self.framePolargraph.setFrameShape(QtWidgets.QFrame.Panel)
        self.framePolargraph.setFrameShadow(QtWidgets.QFrame.Raised)
        self.framePolargraph.setLineWidth(2)
        self.framePolargraph.setObjectName("framePolargraph")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.framePolargraph)
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_6.setSpacing(0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.polargraph = QPolargraphSettings(self.framePolargraph)
        self.polargraph.setMinimumSize(QtCore.QSize(333, 0))
        self.polargraph.setObjectName("polargraph")
        self.verticalLayout_6.addWidget(self.polargraph)
        self.verticalLayout_7.addWidget(self.framePolargraph)
        ...
        self.verticalLayout_7.addWidget(self.labelFunctionGenerator)
        ...
        self.functionGenerator.setMinimumSize(QtCore.QSize(253, 0))
        self.functionGenerator.setObjectName("functionGenerator")
        self.verticalLayout_4.addWidget(self.functionGenerator)
        self.verticalLayout_7.addWidget(self.frameFunctionGenerator)
        ...
        self.verticalLayout_7.addWidget(self.labelLockin)
        self.frameLockin = QtWidgets.QFrame(self.controlWidget)
        self.frameLockin.setFrameShape(QtWidgets.QFrame.Panel)
        self.frameLockin.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameLockin.setLineWidth(2)
        self.frameLockin.setObjectName("frameLockin")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.frameLockin)
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_5.setSpacing(0)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.lockin = QSR830Settings(self.frameLockin)
        self.lockin.setMinimumSize(QtCore.QSize(277, 0))
        self.lockin.setObjectName("lockin")
        self.verticalLayout_5.addWidget(self.lockin)
        self.verticalLayout_7.addWidget(self.frameLockin)
        spacerItem2 = QtWidgets.QSpacerItem(20, 352, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_7.addItem(spacerItem2)
        self.labelPolargraph.raise_()
        self.labelFunctionGenerator.raise_()
        self.frameFunctionGenerator.raise_()
        self.labelLockin.raise_()
        self.frameLockin.raise_()
        self.framePolargraph.raise_()
