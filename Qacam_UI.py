...
class Ui_Qacam(object):
    def setupUi(self, Qacam):
        ...
        self.verticalLayout_5 = QtGui.QVBoxLayout(self.controlWidget)
        ...
        self.labelFunctionGenerator = QtGui.QLabel(self.controlWidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.labelFunctionGenerator.setFont(font)
        self.labelFunctionGenerator.setObjectName(_fromUtf8("labelFunctionGenerator"))
        self.verticalLayout_5.addWidget(self.labelFunctionGenerator)
        self.frameFunctionGenerator = QtGui.QFrame(self.controlWidget)
        self.frameFunctionGenerator.setFrameShape(QtGui.QFrame.Panel)
        self.frameFunctionGenerator.setFrameShadow(QtGui.QFrame.Raised)
        self.frameFunctionGenerator.setLineWidth(2)
        self.frameFunctionGenerator.setObjectName(_fromUtf8("frameFunctionGenerator"))
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.frameFunctionGenerator)
        self.verticalLayout_4.setMargin(0)
        self.verticalLayout_4.setSpacing(0)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.functionGenerator = QDS345Settings(self.frameFunctionGenerator)
        self.functionGenerator.setObjectName(_fromUtf8("functionGenerator"))
    ...
    def retranslateUi(self, Qacam):
        ...
        self.labelFunctionGenerator.setText(_translate("Qacam", "Function Generator", None))
